# Playing catch up
At the end of this session, you should be able to set up and
run a basic LDA+U calculation in RSPt. So, if you haven't
finished the AFM NiO LDA+U calculation from [session 3](../session_3/LDA+U/nio_ldau.md), do so now.

If you have finished the LDA+U calculations, well done! There are of course many more things that can
