...
## Running atom
([see session 1 for more info](../FCC_Ni/fcc_Ni.html#atomic-densities))

Just type `make`, to create `atomdens` in the main directory. No need to change anything, since we used the `up` and `dn` labels.


## Running cub
([see session 1 for more info](../FCC_Ni/fcc_Ni.html#meshing-with-the-k-points))
...
([see session 1 for more info](../FCC_Ni/fcc_Ni.html#the-basics-of-the-basis))
...
## Converge SCF
([see session 1 for more info](../FCC_Ni/fcc_Ni.html#running-rspt))
